...
if __name__ == '__main__':
    ...
    import glob,tqdm
    prefixs = ['val', 'train']
    binarized_ds_path = "data/binary/mead"
    ...
    for prefix in prefixs:
        ...
        raw_base_dir =  '/home/public/wenqing/data/mead'
        ...
        #mead 46 train
        # val set has 114 samples!
        # train set has 11216 samples!

        # mead 46*0.8 train
        # val set has 92 samples!
        # train set has 9025 samples!
