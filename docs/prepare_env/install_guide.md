...
This guide is about building a python environment for RealTalk with Conda.
...
conda create -n realtalk python=3.9
...
You can download a zipped file in this [Google Drive](https://drive.google.com/drive/folders/1o4t5YIw7w4cMUN4bgU9nPf6IyWVG1bEk?usp=drive_link). Unzip it, you can see a `BFM` folder with 8 files. Move these files into the path `<RealTalkRoot>/deep_3drecon/BFM/`. The structure should look like:
```
deep_3drecon/BFM/
