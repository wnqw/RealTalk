...
def get_encoder(encoding, input_dim=3, 
    ...
    if encoding == 'None':
        ...
        from modules.syncnerfs.encoders.freqencoder import FreqEncoder
        encoder = FreqEncoder(input_dim=input_dim, degree=multires)

    elif encoding == 'spherical_harmonics':
        from modules.syncnerfs.encoders.shencoder import SHEncoder
        encoder = SHEncoder(input_dim=input_dim, degree=degree)

    elif encoding == 'hashgrid':
        from modules.syncnerfs.encoders.gridencoder import GridEncoder
